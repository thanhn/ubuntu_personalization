...
if [ -f `brew --prefix`/usr/local/opt/bash-completion ]; then
    . `brew --prefix`/usr/local/opt/bash-completion
fi

# bash_profile from this page http://natelandau.com/my-mac-osx-bash_profile/
